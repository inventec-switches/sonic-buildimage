...
'echo pca9548 0x72> /sys/bus/i2c/devices/i2c-0/i2c-1/new_device',
...
def system_install():
    ...
    for i in range(18,26):
        status, output =exec_cmd("echo sff8436 0x50 > /sys/bus/i2c/devices/i2c-0/i2c-1/i2c-"+str(i)+"/new_device", 1)
        if status:
            print output
            if FORCE == 0:            
                return status   
